    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                      <h2 class="muted">Hey friends, do you want to share your videos?</h2>
                      <button type="submit" class="btn btn-dark float-right" data-toggle="modal" data-target="#videoModal">Post a Video</button>
                    </div>
                </div>
